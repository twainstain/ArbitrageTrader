...
#
# Usage:
#   ./scripts/phase_a_admin.sh                                # defaults below
#   ./scripts/phase_a_admin.sh --bucket foo --role foo-role   # overrides
#
# Defaults target the ArbitrageTrader (EVM) bot. For the Solana bot:
#   ./scripts/phase_a_admin.sh \
#       --bucket arb-trader-data \
#       --role solana-ec2-role \
#       --policy-name SolanaArbS3Backup \
#       --prefix postgres/solana/
set -euo pipefail

BUCKET="arb-trader-data"
REGION="us-east-1"
ROLE="arb-trader-ec2-role"
POLICY_NAME="ArbTraderS3Backup"
PREFIX="postgres/"
