...
Usage::
    ...
    PYTHONPATH=src python -m fork_scanner --parent "Uniswap V3"

    # Find forks on a specific chain with minimum TVL
    PYTHONPATH=src python -m fork_scanner --parent "Uniswap V3" --chain Ethereum --min-tvl 1000000

    # List all DEX forks
    PYTHONPATH=src python -m fork_scanner --all-dex-forks
"""
